            ...
            <div class="container mar-b-20 ${savedBooking.status != 'CONFIRMED' ? 'invisible' : ''}">
              <form action="admin-manage-booking-add-charge" method="POST">
                ...
                <div class="form-group row col-md-12">
                  ...
                  <input type="number" class="form-control col-md-2" name="rate" step="0.10" required>
                  <button type="submit" class="btn btn-primary mar-l-20" id="btnAddCharge">Add Charge <i class="fa fa-paper-plane-o" aria-hidden="true"></i></button> 
                </div>
              </form>
            </div>
            <div class="container">
