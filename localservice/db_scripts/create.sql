...
create table room (id integer generated by default as identity, capacity integer not null, capacity_children integer not null, code varchar(255), description varchar(255), name varchar(255), rate double not null, status varchar(255), type varchar(255), primary key (id))
